...
Step 4. Update: If the current element is greater than the current maximum, update the maximum.
Step 5. Return: After the loop, the maximum element will be the largest one.*/
